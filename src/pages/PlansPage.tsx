...
import { moneyFa } from '../lib/format'
...
export default function PlansPage() {
  ...
  async function save() {
    ...
    setBusy(true)
    try {
      const result = await api<Config>('/admin/pap-settings/', { method:'POST', body:jsonBody(requested) })
      const optimistic = { ...result, premium_plan_price:requested.premium_plan_price, per_normal_play_pay:requested.per_normal_play_pay, per_premium_play_pay:requested.per_premium_play_pay, minimum_payout_amount:requested.minimum_payout_amount, ad_frequency:requested.ad_frequency }
